        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/regident') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('link') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="link" type="text" class="form-control" name="link" value="{{ old('links') }}" required>
